        ...
        <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-50 p-4">
          ...
          <div className="bg-white rounded-2xl shadow-2xl w-full max-w-2xl p-6 max-h-[90vh] overflow-y-auto">
            ...
            <div className="flex justify-between items-start mb-4">
              ...
              <span className={`px-3 py-1 rounded-full text-xs font-semibold ${STATUS_STYLE[selected.status]}`}>
            ...
            <div className="border-t pt-3 space-y-1">
              ...
              {selected.discount > 0 && (
                <div className="flex justify-between text-sm text-gray-500">
                  ...
                  <span>
                    {formatRupiah(selected.total_price + Number(selected.discount_amount))}
                  </span>
            ...
            <button
              ...
              className="w-full mt-6 py-3 border rounded-xl hover:bg-gray-50"
            >
              Tutup
            </button>
